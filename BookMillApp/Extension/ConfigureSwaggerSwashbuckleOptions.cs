...
namespace BookMillApp.Extension
{
    ...
    public class ConfigureSwaggerSwashbuckleOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        private static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                Title = "BookMill Application",
                Version = description.ApiVersion.ToString(),
                Description = "An app that helps both the Manufacturer(Recycling companies)Suppliers  to collect  old and used books from corporate bodies, individual homes/schools to Recycle.",
